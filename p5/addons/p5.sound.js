            ...
            return (
                ...
                (o.TimelineSignal.prototype.setTargetAtTime = function (e, t, i) {
                    return (
                        ...
                        (t = this.toSeconds(t)),
                        this._events.add({ type: o.TimelineSignal.Type.Target, value: e, time: t, constant: i }),
        ...
        (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
            ...
            return (
                ...
                (o.Clock.prototype._loop = function () {
                    for (
                        var t =
                            this.now() + this.context.lookAhead + this.context.updateInterval + 2 * this.context.lag;
        ...
        (__WEBPACK_AMD_DEFINE_RESULT__ = function (n) {
            return (
                ...
                (n.TimeBase.prototype._tokenize = function (e) {
                    ...
                    function i(e, t) {
                        for (
                            var r = ['_binaryExpressions', '_unaryExpressions', '_primaryExpressions', '_syntaxGlue'],
                                n = 0;
                            n < r.length;
                            n++
                        ) {
                ...
                (n.TimeBase.prototype._parseBinary = function (e, t) {
                    ...
                    for (var n = e.peek(); n && this._matchGroup(n, this._binaryExpressions, t); )
                        (r = (n = e.next()).method.bind(this, r, this._parseBinary(e, t - 1))), (n = e.peek());
                    return r;
                }),
            ...
            return (
                ...
                (a.Param.prototype.rampTo = function (t, e, i) {
                    return (
                        ...
                        this.units === a.Type.Frequency || this.units === a.Type.BPM || this.units === a.Type.Decibels
        ...
        !(function () {
            ...
            'function' != typeof AudioWorkletNode &&
                ((self.AudioWorkletNode = function (e, t, r) {
                    ...
                    return (
                        (l = null), (n.port = u.port1), (n.processor = o), (n.instance = c), (n.onaudioprocess = p), n
                    );
                }),
            ...
            return (
                ...
                (p.Expr.prototype._disposeNodes = function () {
                    for (var e = 0; e < this._nodes.length; e++) {
                        var n = this._nodes[e];
                        this.isFunction(n.dispose) ? n.dispose() : this.isFunction(n.disconnect) && n.disconnect(),
                            (n = null),
                            (this._nodes[e] = null);
                    }
                    this._nodes = null;
